...
uint32_t Spw_Rx_getIrq(){ return 0; }

uint32_t Spw_Rx_getIrqMasked(){ return 0; }

uint32_t Spw_Rx_getAndClearIrq(){ return 0; }

uint32_t Spw_Rx_getAndClearIrqMasked(){ return 0; }
