...
typedef struct {
	/// @brief Whether an EEP sent interrupt is pending.
	bool eepSentIrqOccurred;
	/// @brief Whether an EOP sent interrupt is pending.
	bool eopSentIrqOccurred;
	/// @brief Whether a Send List activated interrupt is pending.
	bool sendListActivatedIrqOccurred;
	/// @brief Whether a Send List deactivated interrupt is pending.
...
/// @param[in] tx     Tx descriptor.
/// @param[in] config Send List configuration.
void Spw_Tx_setNextSendList(Spw_Tx *const tx,
			    const Spw_Tx_SendListConfig *const config);

/// @brief Sets next Send List entry.
/// @param[in] entry       Send List entry.
/// @param[in] entryStruct Send List entry structure.
...
/// @param[in] tx Tx descriptor.
/// @param[out] config Send List configuration.
...
/// @param[in] entry       Send List entry.
/// @param[out] entryStruct Send List entry structure.
...
/// @param[in] linkIrqStatusValue Interrupt status register value.
/// @param[out] status Decoded interrupt status structure.
...
/// @param[in] tx Tx descriptor.
/// @param[out] status PktTx status structure.
