...
uint32_t Spw_Tx_getIrq(){ return 0; }

uint32_t Spw_Tx_getIrqMasked(){ return 0; }

uint32_t Spw_Tx_getAndClearIrq(){ return 0; }

uint32_t Spw_Tx_getAndClearIrqMasked(){ return 0; }
