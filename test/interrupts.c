...
extern void FLEXRAMECC_INTNOFIX_Handler(void)
  __attribute__((weak, alias("Dummy_Handler"), noreturn));
...
extern void TC0_CH0_InterruptHandler(void) __attribute__((weak, alias("Dummy_Handler"), noreturn));
extern void TC0_CH1_InterruptHandler(void) __attribute__((weak, alias("Dummy_Handler"), noreturn));
extern void TC0_CH2_InterruptHandler(void) __attribute__((weak, alias("Dummy_Handler"), noreturn));
